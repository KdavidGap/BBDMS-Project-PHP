	...
	<div class="banner-bottom py-5">
		<div class="d-flex container py-xl-3 py-lg-3">
			<div class="banner-left-bottom-w3ls offset-lg-2 offset-md-1">
				<h3 class="text-white my-3">Juba Teaching Hospital have High professional doctors</h3>
				<p>all specialists in Juba Teaching Hospital have extensive practical experience and regularly training courses in educational centers in South Sudan and across the
					world</p>
			</div>
			<div class="button">
...
<li>AB positive or AB negative.</li>
                ...
                <p>A healthy diet helps ensure a successful blood donation, and also makes you feel better! Check out the following recommended foods to eat prior to your donation, only for those who give blood take a good care to them.</p>
            </div>
            <div class="col-lg-6">
